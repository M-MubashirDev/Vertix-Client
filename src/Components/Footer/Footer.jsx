...
function Heads({ children }) {
  return (
    ...
    <h1 className="h1-heading  text-primary-dark ">{children}</h1>
  );
}
...
function Button({ children }) {
  ...
  return (
    <button
      ...
      className="relative inline-flex items-center justify-center  overflow-hidden  font-medium tracking-tighter  group border sm:place-self-center px-4 py-8 sm:px-1 sm:py-2  border-primary-dark rounded-[10px] text-[14px] sm:text-[16px]  w-[80%] h-11 bg-primary-dark text-white hover-white hover-styling"
    >
