const ExpandableButton = ({ icon, text }) => {
  return (
    <button className="flex items-center justify-start w-[80px] h-[80px] border-none rounded-full cursor-pointer relative overflow-hidden transition-all duration-300 shadow-[2px_2px_10px_rgba(0,0,0,0.199)] bg-primary hover:w-[140px]  hover:rounded-[40px] active:translate-x-[2px] active:translate-y-[2px] group hover:pl-3">
      {/* Icon Container */}
